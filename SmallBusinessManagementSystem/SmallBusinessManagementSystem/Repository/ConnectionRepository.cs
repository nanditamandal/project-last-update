...
namespace SmallBusinessManagementSystem.Repository
{
    public class ConnectionRepository
    {
        ...
        {
            return @"Server=DESKTOP-077IM0O; Database=Project1DB; Integrated Security = True";
        }
        ...
        public bool ConnectAndMakeSqlCommand(string commandString)
        {
            ...
            try
            {
                string _connectionString = @"Server=DESKTOP-077IM0O; Database=Project1DB; Integrated Security = True";
