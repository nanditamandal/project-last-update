    ...
    public partial class SalesUI : Form
    {
        ...
        private void AddButton_Click(object sender, EventArgs e)
        {
            ...
            if (message.Equals("True"))
            {
                ...
                if (_salesManager.IsReorderLevelReached(_salesModel)) MessageBox.Show("Reorder Level Reached!");
        ...
        private void CustomerComboBox_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (_isCustomerSelected)
            {
                ...
                discountTextBox.Text = _salesManager.GetInfo("discountPercentage", Convert.ToDouble(loyaltyPointTextBox.Text));
                categoryComboBox.SelectedIndex = -1;
                productComboBox.SelectedIndex = -1;
                availableQuantityTextBox.Text = null;
                quantityTextBox.Text = null;
